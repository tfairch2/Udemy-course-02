...
#include <queue>
#include <fstream>
/*Using a Queue to pair up partners for a square dance by taking names from a queue of men
    and one of women and pairing the top of each to make a pair*/
using namespace std;
...
int main()
{
    ...
    /*Dancing partners are taken from each queue, men and women queues, and as long as both queues
        have elements, pairs can be made.*/
